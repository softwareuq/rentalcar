...
@section('content')
  ...
  {!! Form::open(['route'=>['management.marcas.update',$marca],'method'=>'PUT','class'=>'form-horizontal']) !!}
    <div class="form-group">
      <label class="control-label col-sm-2 col-sm-offset-3 col-md-2 col-md-offset-3" for="nombre">Nombre:</label>
      <div class="col-sm-3 col-md-3">
        <input class="form-control" type="text" name="nombre" value="{{$marca->nombre}}" placeholder="Nombre" required>
      </div>
    </div>
